...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button2 = (Button) findViewById(R.id.button2); //findViewById uses the ids you specified in the xml!
       ...
       button2.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {
               //send a float to PD("the name of the [receive] object in pd to send to", the value of the send);
